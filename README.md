...
## Импорт мероприятий из .xlsx файлов

Подразумевается, что таблицы будут заполнены с первой клетки документа и будут иметь следующую структуру:

| Название | Описание | Дата публикации     | Начало              | Завершение          | Место проведения | Координаты          | Рейтинг |
|----------|----------|---------------------|---------------------|---------------------|------------------|---------------------|---------|
| Пример   | Тест     | 2026-04-14 10:00:00 | 2026-04-15 09:00:00 | 2026-04-15 19:00:00 | Кафе "Заря"      | 55.990655;93.005841 | 4.3     |
